...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '12345').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '12345'))
...
URL = "hhttps://mn-auto-filter-mnbots-5a155094.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mn-auto-filter-mnbots-5a155094.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mn-auto-filter-mnbots-5a155094.koyeb.app/".format(FQDN)
else:
    URL = "https://mn-auto-filter-mnbots-5a155094.koyeb.app/".format(FQDN)
