...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6447027974').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Pubg:Pubg@cluster0.hadfzet.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MN_MOVIES_GROUP')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+iWHbh20hiow3M2I1')
...
URL = "https://neha-jisshubot.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://neha-jisshubot.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://neha-jisshubot.koyeb.app/".format(FQDN)
else:
    URL = "https://neha-jisshubot.koyeb.app/".format(FQDN)
